...
* Troca o tipo de **sola** conforme o terreno
* Ajusta o aperto no pé
* Mostra **nível de umidade e sujeira**
* Tem um botão de **autolimpeza** (sim, tênis do futuro, aceita)
...
Projeto desenvolvido como **atividade escolar**, focado em:

* Criar um produto inovador que ainda não exista ou seja pouco otimizado
